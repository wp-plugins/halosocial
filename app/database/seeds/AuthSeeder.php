	...
	*/
	public function getPermissionSettings() {
		return  $permission = array(
        	array(
            	'name'		 	=> 'backend.view',
            	'description'   => __halotext('Allow to view backend')
        	),
        	array(
            	'name'		 	=> 'site.view',
            	'description'   => __halotext('Allow to view frontend')
            ),
            array(
            	'name'		 	=> 'user.view',
            	'description'   => __halotext('Allow to view user profile')
            ),
            array(
            	'name'		 	=> 'user.edit',
            	'description'   => __halotext('Allow to edit user profile')
            ),
            array(
            	'name'		 	=> 'user.delete',
            	'description'   => __halotext('Allow to delete user profile')
            ),       	
            array(
            	'name'		 	=> 'comment.view',
            	'description'   => __halotext('Allow to comment')
            ),
            array(
            	'name'		 	=> 'comment.create',
            	'description'   => __halotext('Allow to create new comment')
            ),
            array(
            	'name'		 	=> 'comment.edit',
            	'description'   => __halotext('Allow to edit comment')
            ),
            array(
            	'name'		 	=> 'comment.delete',
            	'description'   => __halotext('Allow to delete comment')
            ),
            array(
            	'name'		 	=> 'activity.create',
            	'description'   => __halotext('Allow to create new activities')
            ),
            array(
            	'name'		 	=> 'activity.edit',
            	'description'   => __halotext('Allow to edit activities')
            ),
            array(
            	'name'		 	=> 'activity.delete',
            	'description'   => __halotext('Allow to delete an activity')
            )       	
            ,array(
            	'name'		 	=> 'user.changeProfile',
            	'description'   => __halotext('Allow to change user profile type')
            )       	
            ,array(
            	'name'		 	=> 'review.create',
            	'description'   => __halotext('Allow to create new review')
            )       	
            ,array(
            	'name'		 	=> 'review.edit',
            	'description'   => __halotext('Allow to edit a review')
            )       	
            ,array(
            	'name'		 	=> 'review.approve',
            	'description'   => __halotext('Allow to edit a review')
            ...
            ,array(
            	'name'		 	=> 'review.delete',
            	'description'   => __halotext('Allow to delete a review')
            )       	
		);
	}
}
