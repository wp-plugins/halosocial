...
<!-- Container -->
<div id="halo-wrap" class="halow container-fluid halo-admin-wrapper">
	{{-- Navbar --}}
	...
	<?php
		...
		$nav->addUI('left_nav@array', HALOUIBuilder::getInstance('','',array('url'=>'?app=admin&view=tools','title'=>__halotext('Tools')))
										...
										->addUI('dropdown@array', HALOUIBuilder::getInstance('','',array('url'=>'?app=admin&view=filters', 'title'=>__halotext('Filters'))))
