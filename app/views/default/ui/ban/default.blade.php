	...
	<div class="halo-ban-form">
		<table>
			...
			<tr class="halo-ban-setting">
				...
				<td>
					<input data-a-sep="." data-m-dec="0" data-a-dec="," class="form-control haloj-auto-numeric halo-ban-duration @if(empty($setting['value'])) hidden @endif" type="text" name="ban_duration[{{{$index++}}}]" value="" min="1"/>
				</td>
			</tr>
			@endforeach
			</tbody>
