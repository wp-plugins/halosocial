			...
			@if (HALOAuth::hasRole('registered'))
				...
				<li class="halo-dropdown">
				  ...
				  <ul class="halo-dropdown-menu halo-nicescroll" role="menu">
					<li><a href="{{$my->getUrl()}}">{{__halotext('My Profile')}}</a></li>
                    <li class="divider"></li>
                    <li><a href="{{ URL::to('?view=message&task=show') }}">{{__halotext('My Messages')}}</a></li>
                    <li><a href="{{ URL::to('?view=user&task=edit&uid=' . $my->id) }}">{{__halotext('Edit User')}}</a></li>
