		...
		<div class="panel panel-default halo-share-box">
			<div class="panel-heading halo-status-heading">
				<h3 class="panel-title">
                    ...
                    <span class="halo-status-loading"></span>
				</h3>
			</div>
			<div class="panel-body">
				...
				<form class="halo-data-confirm-wrapper" name="status_form" id="status_form" role="form">
					...
					<textarea data-resetable data-raw-input="share_message" data-confirm class="form-control halo-status-box"
					          name="{{$builder->name}}" placeholder="{{{$builder->placeholder}}}"
                              data-loading=".halo-status-loading" data-complete="system.AddShareLinkBlock.haloLoading" data-replace="true" data-auto-show="false"></textarea>
				</form>
				<form name="status_form_info" id="status_form_info" role="form">
					...
					<div class="row halo-status-function hidden">
						...
						<div class="halo-status-post-option c
						ol-md-8 text-right">
							<button data-loading data-complete="status.SubmitStatus.haloLoading" data-replace="true" type="button" onclick="halo.status.submit();"
