...
<div class="form-group">
	...
	<div data-tree-select class="halo-btn-group {{$builder->getSize()}}">
        ...
        'btn-xs')}}"
		        data-htoggle="dropdown" title="{{__halotext('Privacy')}}">
	...
	<div class="halo-wizard-wrapper" {{$builder->getZone()}} {{$builder->getData()}}>
		...
		<div class="halo-wizard-actions halo-center-block">
			<div class="halo-btn-group">
			  <button type="button" @if($builder->onPrevious) onclick="{{$builder->onPrevious}}" @endif class="halo-wizard-btn-previous halo-btn halo-btn-primary">{{__halotext('Previous')}}</button>
			  <button type="button" @if($builder->onNext) onclick="{{$builder->onNext}}" @endif class="halo-wizard-btn-next halo-btn halo-btn-primary">{{__halotext('Next')}}</button>
			  @if($builder->onFinish)
			  <button type="button" onclick="{{$builder->onFinish}}" class="halo-wizard-btn-finish halo-btn halo-btn-success">@if($builder->getData('finishTitle')) {{$builder->data['finishTitle']}} @else {{__halotext('Finish')}} @endif</button>
			  @endif 
			  @if($builder->onCancel)
