...
define('HALO_MEDIA_BASE_DIR',wp_upload_dir()['basedir'] . '/halosocial');		//media upload dir
define('HALO_MEDIA_BASE_URL',wp_upload_dir()['baseurl'] . '/halosocial');		//media upload url
/** media status value */
