...
class AdminUsersController extends AdminController {
    ...
    public function getIndex()
    {
		...
		// Toolbar
		HALOToolbar::addToolbar(__halotext('Add User'),'halo-btn-success',URL::to('?app=admin&view=users&task=create'),'','plus');
//		HALOToolbar::addToolbar(__halotext('Block User'),'','','halo.user.showEditProfileForm(0)','unlock-alt');
		HALOToolbar::addToolbar(__halotext('Delete User'),'halo-btn-danger','',"halo.popup.confirmDelete('Delete User Confirm','Are you sure to delete this user?','halo.user.deleteSelectedUser()')",'times');
    ...
    public function getEdit($userId)
    {
        ...
        if ( $user->id )
        {
			...
			// Toolbar
			HALOToolbar::addToolbar('Save','halo-btn-primary','',"halo.form.submit('halo-admin-form')",'save');
			HALOToolbar::addToolbar('Cancel','halo-btn-default',URL::to('?app=admin&view=users'),'','undo');
