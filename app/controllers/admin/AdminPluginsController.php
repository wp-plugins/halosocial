...
class AdminPluginsController extends AdminController
{
    ...
    public function getIndex()
    {
		...
		// Toolbar
		HALOToolbar::addToolbar('Install Plugin','halo-btn-success','','halo.plugin.showInstallPluginForm()','plus');
		HALOToolbar::addToolbar('Uninstall Plugin','halo-btn-danger','',"halo.popup.confirmDelete('Uninstall Plugin Confirm','Are you sure to uninstall this plugin?','halo.plugin.deleteSelectedPlugin()')",'times');
