...
class AdminFieldsController extends AdminController
{
    ...
    public function getIndex()
    {
		...
		if(HALOAuth::can('feature.profile')){
			HALOToolbar::addToolbar('Add Field','','','halo.field.showEditFieldForm(0)','plus');
			HALOToolbar::addToolbar('Delete Field','','',"halo.popup.confirmDelete('Delete Field Confirm','Are you sure to delete this field','halo.field.deleteSelectedField()')",'times');
		} else {
