...
class AdminReportsController extends AdminController
{
    ...
    public function getIndex()
    {
		...
		// Toolbar
		HALOToolbar::addToolbar('Delete Report','','',"halo.popup.confirmDelete('Delete Report Confirm','Are you sure to delete this report?','halo.report.deleteSelectedReport()')",'times');
