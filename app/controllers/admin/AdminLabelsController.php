...
class AdminLabelsController extends AdminController
{
	...
	public function getIndex()
	{
		...
		// Toolbar
		HALOToolbar::addToolbar('Add Label Group','','','halo.label.showEditLabelGroupForm(0)','plus');
		HALOToolbar::addToolbar('Delete Label Group','','',"halo.popup.confirmDelete('Delete Label Group Confirm','Are you sure to delete this label group','halo.label.deleteSelectedLabelGroup()')",'times');
