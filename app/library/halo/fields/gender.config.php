 ...
 */
	...
	return json_encode(array(//ui define
							array("title" => "Options",							//sample format: json array string where first element must be header strings
								"_type" => "form.jsontable",					//[["title","value"],["Yes","1"],["No","0"]]
								"name" => "options",
								"class" => "halo-hide-header",
								"helptext" => __halotext('List of selectable options'),
								"default" => '[["title"],["' . __halotext('Male') . '"],["' . __halotext('Female') . '"]]'),
