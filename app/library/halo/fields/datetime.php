...
class HALOFieldDatetime extends HALOField
{
    ...
    public function getEditableUI()
    {
        ...
        $fieldBuilder = HALOUIBuilder::getInstance('', 'field.datetime', array('id' => $this->id, 'name' => 'field[' . $this->id . ']',
            																...
            																'data' => array('confirm' => Input::old('field.' . $this->id, $val),
            )));
