...
class HALOConfig
{
    ...
    public static $_namespaces = null;
        ...
        if (!App::isBooted()) {
			...
			try {
				...
				$namespaces->each(function ($namespace) {
					$namespace->initParam();
					HALOConfig::$_namespaces[$namespace->param_name] = $namespace;
				});
			} catch(\Exception $e) {
    ...
    public static function set($param, $value)
    {
		...
		if(is_null($value)) {
			//consider as clear action
			self::$_namespaces[$namespace]->clearParam($paramName);
		} else {
