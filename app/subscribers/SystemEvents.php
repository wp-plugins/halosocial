...
define('HALO_ACTIVITY_LIMIT_DISPLAY', HALOConfig::get('global.activityQueryLimit', 12));
...
if (!function_exists('__halontext')) {
    ...
    {
        return sprintf(_n($msg1, $msg2, $n, $domain), $n);
    }
}
...
class SystemEventHandler
{
    ...
    public function subscribe($events)
    {
		...
		$events->listen('auth.getPermissionSource', function($permission) {
			...
			if(in_array($permission->name, $corePermission)) {
				$permission->setSourceName('HaloSocial Core');
			}
		});

        // wp options
        $events->listen('system.onAfterChangeConfig', function() {
            update_option('halo_register_url', URL::to('?view=user&task=register'));
            update_option('halo_register_form', HALOConfig::get('user.haloregistration', 1));
        });

		//theme customize
		$events->listen('system.customizeTheme', function($data, $themeSettings) {
            //get css override settings
            $cssOverride = isset($data['theme.css.override'])?$data['theme.css.override']:'';

            $themeSettings->sassArr[] = array('file' => 'halo.scss', 'scss' => 'scss/', 'css' => '');
            $themeSettings->sassArr[] = array('file' => 'halo.scss', 'scss' => 'scss/', 'css' => '', 'format' => 'scss_formatter_compressed', 'append' => $cssOverride);
			$themeSettings->sassArr[] = array('file' => 'override.scss', 'scss' => 'scss/', 'css' => '', 'append' => $cssOverride);
			$themeSettings->sassArr[] = array('file' => 'halosingle.scss', 'scss' => 'scss/', 'css' => '');
			$themeSettings->sassArr[] = array('file' => 'halosingle.scss', 'scss' => 'scss/', 'css' => '', 'format' => 'scss_formatter_compressed');
			$themeSettings->sassArr[] = array('file' => 'wptheme_comp.scss', 'scss' => 'scss/', 'css' => '');
			$themeSettings->sassArr[] = array('file' => 'wptheme_comp.scss', 'scss' => 'scss/', 'css' => '', 'format' => 'scss_formatter_compressed');
			$themeSettings->sassArr[] = array('file' => 'bootstrap.scss', 'scss' => 'scss/', 'css' => '');
			$themeSettings->sassArr[] = array('file' => 'bootstrap.scss', 'scss' => 'scss/', 'css' => '', 'format' => 'scss_formatter_compressed');
			$themeSettings->sassArr[] = array('file' => 'fontawesome.scss', 'scss' => 'scss/', 'css' => '');
			$themeSettings->sassArr[] = array('file' => 'fontawesome.scss', 'scss' => 'scss/', 'css' => '', 'format' => 'scss_formatter_compressed');
			$themeSettings->sassArr[] = array('file' => 'magnific_popup.scss', 'scss' => 'scss/', 'css' => '');
			$themeSettings->sassArr[] = array('file' => 'magnific_popup.scss', 'scss' => 'scss/', 'css' => '', 'format' => 'scss_formatter_compressed');
			
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.color.default', 'var' =>'color-default');
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.color.primary', 'var' =>'color-primary');
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.color.success', 'var' =>'color-success');
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.color.info', 'var' =>'color-info');
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.color.warning', 'var' =>'color-warning');
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.color.danger', 'var' =>'color-danger');
			
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.color.font', 'var' =>'color-halo-text');
            $themeSettings->varsMap[] = array('cfgKey' => 'theme.color.background', 'var' =>'color-background');
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.color.border', 'var' =>'color-border');
            $themeSettings->varsMap[] = array('cfgKey' => 'theme.font.size', 'var' =>'font-size-base');

            //theme override
			$themeSettings->varsMap[] = array('cfgKey' => 'theme.css.override');
		});
    }
    ...
    public function onLoadSocialSetttings(HALOObject $meta)
    {
        ...
        $meta->setNsArray('social.facebook.shareEnable', array("title" => __halotext("Enable Facebook Sharing"),
            "_type" => "form.radio",
            "help" => '',
        ...
        $meta->setNsArray('social.google.shareEnable', array("title" => __halotext("Enable Google Sharing"),
            "_type" => "form.radio",
            "help" => '',
            'options' => array(array('value' => '1', 'title' => __halotext('Yes')),
                array('value' => '0', 'title' => __halotext('No')),
        ...
        // Recaptcha
        //Facebook
        $meta->setNsArray('social.recaptcha._meta', array("title" => __halotext("reCaptcha"),
            "icon" => "",
            "help" => '',
        ));
        $meta->setNsArray('social.recaptcha.site', array("title" => __halotext("Site key"),
            "_type" => "form.text",
            "helptext" => __halotext('Use this in the HTML code your site serves to users.'),
            'value' => HALOConfig::get('recaptcha.site'),
            "name" => "recaptcha.site"));

        $meta->setNsArray('social.recaptcha.secret', array("title" => __halotext("Secret key"),
            "_type" => "form.text",
            "helptext" => __halotext('Use this for communication between your site and Google. Be sure to keep it a secret.'),
            'value' => HALOConfig::get('recaptcha.secret'),
    ...
    public function onAjaxResponse()
    {
        ...
        if (HALOConfig::get('global.showOnline', 1) && !empty(HALOOnlineuserModel::$_queuedIds)) {
            HALOResponse::addScriptCall('halo.online.updateStatus', HALOOnlineuserModel::getOnlineJson());
                    ...
                    //ga collecting
        if (HALOConfig::get('global.GAEnable', 0) && !empty(HALOGATracking::$hits)) {
