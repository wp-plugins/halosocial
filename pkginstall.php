...
function halo_admin_content(){
	...
	?>
		<div class="wrap">
			...
			<h2>Requirement checking.</h2>
			<h3>Your system does not meet minimum requirement of this plugin. Please check this <a target="_blank" href="http://www.halo.social/requirements">document</a> for more information</h3>
			<div class="">
